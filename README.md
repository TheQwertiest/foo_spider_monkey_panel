...
I also removed some `fb` methods in `v1.6.0` because there are identical `plman` methods which are also supported in the official component `v1.5.0` and above.
