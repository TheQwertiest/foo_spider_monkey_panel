...
public:
    ...
    BEGIN_DLGRESIZE_MAP( CConfigTabPackage )
        DLGRESIZE_CONTROL( IDC_GROUP_PKG_FILES, DLSZ_SIZE_X | DLSZ_SIZE_Y )
        DLGRESIZE_CONTROL( IDC_LIST_PACKAGE_FILES, DLSZ_SIZE_X | DLSZ_SIZE_Y )
        ...
        DLGRESIZE_CONTROL( IDC_BUTTON_OPEN_FOLDER, DLSZ_MOVE_X | DLSZ_MOVE_Y )
        DLGRESIZE_CONTROL( IDC_GROUP_PKG_INFO, DLSZ_MOVE_X | DLSZ_SIZE_Y )
        DLGRESIZE_CONTROL( IDC_LTEXT_NAME, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_EDIT_PACKAGE_NAME, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_LTEXT_VERSION, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_EDIT_PACKAGE_VERSION, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_LTEXT_AUTHOR, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_EDIT_PACKAGE_AUTHOR, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_LTEXT_DESCRIPTION, DLSZ_MOVE_X )
        DLGRESIZE_CONTROL( IDC_EDIT_PACKAGE_DESCRIPTION, DLSZ_MOVE_X | DLSZ_SIZE_Y )
        DLGRESIZE_CONTROL( IDC_GROUP_PANEL_BEHAVIOUR, DLSZ_MOVE_X | DLSZ_MOVE_Y )
        DLGRESIZE_CONTROL( IDC_CHECK_SHOULD_GRAB_FOCUS, DLSZ_MOVE_X | DLSZ_MOVE_Y )
        DLGRESIZE_CONTROL( IDC_CHECK_ENABLE_DRAG_N_DROP, DLSZ_MOVE_X | DLSZ_MOVE_Y )
    END_DLGRESIZE_MAP()
