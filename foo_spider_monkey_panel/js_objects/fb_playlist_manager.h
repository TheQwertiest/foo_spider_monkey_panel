...
public:
    ...
    uint32_t CreateAutoPlaylist( uint32_t playlistIndex, const std::u8string& name, const std::u8string& query, const std::u8string& sort = "", uint32_t flags = 0 );
    uint32_t CreateAutoPlaylistWithOpt( size_t optArgCount, uint32_t playlistIndex, const std::u8string& name, const std::u8string& query, const std::u8string& sort, uint32_t flags );
    uint32_t CreatePlaylist( uint32_t playlistIndex, const std::u8string& name );
    uint32_t DuplicatePlaylist( uint32_t from, const std::u8string& name = "" );
    uint32_t DuplicatePlaylistWithOpt( size_t optArgCount, uint32_t from, const std::u8string& name );
    ...
    uint32_t FindOrCreatePlaylist( const std::u8string& name, bool unlocked );
    int32_t FindPlaybackQueueItemIndex( JsFbMetadbHandle* handle, uint32_t playlistIndex, uint32_t playlistItemIndex );
    int32_t FindPlaylist( const std::u8string& name );
    ...
    bool RenamePlaylist( uint32_t playlistIndex, const std::u8string& name );
    ...
    bool SortByFormat( uint32_t playlistIndex, const std::u8string& pattern, bool selOnly = false );
    bool SortByFormatWithOpt( size_t optArgCount, uint32_t playlistIndex, const std::u8string& pattern, bool selOnly );
    bool SortByFormatV2( uint32_t playlistIndex, const std::u8string& pattern, int8_t direction = 1 );
    bool SortByFormatV2WithOpt( size_t optArgCount, uint32_t playlistIndex, const std::u8string& pattern, int8_t direction );
