...
public:
    ...
    bool RenamePlaylist( uint32_t playlistIndex, const pfc::string8_fast& name );
    ...
    bool SortByFormat( uint32_t playlistIndex, const pfc::string8_fast& pattern, bool selOnly = false );
    bool SortByFormatWithOpt( size_t optArgCount, uint32_t playlistIndex, const pfc::string8_fast& pattern, bool selOnly );
    bool SortByFormatV2( uint32_t playlistIndex, const pfc::string8_fast& pattern, int8_t direction = 1 );
    bool SortByFormatV2WithOpt( size_t optArgCount, uint32_t playlistIndex, const pfc::string8_fast& pattern, int8_t direction );
