...
public:
    ...
    std::optional<bool> SortByFormat( uint32_t playlistIndex, const std::string& pattern, bool selOnly = false);
    std::optional<bool> SortByFormatWithOpt( size_t optArgCount, uint32_t playlistIndex, const std::string& pattern, bool selOnly );
    std::optional<bool> SortByFormatV2( uint32_t playlistIndex, const std::string& pattern, int8_t direction = 1);
    std::optional<bool> SortByFormatV2WithOpt( size_t optArgCount, uint32_t playlistIndex, const std::string& pattern, int8_t direction );
