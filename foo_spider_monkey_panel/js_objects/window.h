...
public: // methods
    ...
    std::optional<JSObject*> CreateTooltip( const std::wstring& name /* = "Segoe UI" */, float pxSize = 12, uint32_t style = 0 );
    std::optional<JSObject*> CreateTooltipWithOpt( size_t optArgCount, const std::wstring& name, float pxSize, uint32_t style );
    std::optional<uint32_t> GetColourCUI( uint32_t type, const std::wstring& guidstr /* = NULL */ );
    ...
    std::optional<JSObject*> GetFontCUI( uint32_t type, const std::wstring& guidstr /* = NULL */ );
    ...
    std::optional<JS::Heap<JS::Value>> GetProperty( const std::string& name, JS::HandleValue defaultval /* = NULL */ );
    ...
    std::optional<std::nullptr_t> SetProperty( const std::string& name, JS::HandleValue val /* NULL to remove! */);
    std::optional<std::nullptr_t> SetPropertyWithOpt( size_t optArgCount, const std::string& name, JS::HandleValue val /* NULL to remove! */ );
