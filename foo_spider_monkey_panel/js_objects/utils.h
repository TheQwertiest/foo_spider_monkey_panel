...
public:
    std::optional<bool> CheckComponent( const std::string& name, bool is_dll = true );
    std::optional<bool> CheckComponentWithOpt( size_t optArgCount, const std::string& name, bool is_dll );
    ...
    std::optional<JSObject*> GetAlbumArtEmbedded( const std::string& rawpath, uint32_t art_id = 0);
    std::optional<JSObject*> GetAlbumArtEmbeddedWithOpt( size_t optArgCount, const std::string& rawpath, uint32_t art_id );
    ...
    std::optional<JSObject*> Glob( const std::string& pattern, uint32_t exc_mask = FILE_ATTRIBUTE_DIRECTORY, uint32_t inc_mask = 0xFFFFFFFF );
    std::optional<JSObject*> GlobWithOpt( size_t optArgCount, const std::string& pattern, uint32_t exc_mask, uint32_t inc_mask );
