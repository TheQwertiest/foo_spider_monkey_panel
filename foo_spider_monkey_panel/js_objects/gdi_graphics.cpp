...
MJS_WRAP_NATIVE_FN( JsGdiGraphics, CalcTextHeight )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, CalcTextWidth )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, DrawEllipse )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, DrawImage )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, DrawLine )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, DrawPolygon )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, DrawRect )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, DrawRoundRect )
MJS_WRAP_NATIVE_FN_WITH_OPT( JsGdiGraphics, DrawString, DrawStringWithOpt, 1 )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, FillEllipse )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, FillGradRect )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, FillPolygon )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, FillRoundRect )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, FillSolidRect )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, GdiAlphaBlend )
MJS_WRAP_NATIVE_FN( JsGdiGraphics, GdiDrawBitmap )
MJS_WRAP_NATIVE_FN_WITH_OPT( JsGdiGraphics, SetInterpolationMode, SetInterpolationModeWithOpt, 1 )
MJS_WRAP_NATIVE_FN_WITH_OPT( JsGdiGraphics, SetSmoothingMode, SetSmoothingModeWithOpt, 1 )
MJS_WRAP_NATIVE_FN_WITH_OPT( JsGdiGraphics, SetTextRenderingHint, SetTextRenderingHintWithOpt, 1 )
