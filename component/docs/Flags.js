...
const BF_MIDDLE   = 0x0800;  /* Fill in the middle */
const BF_SOFT     = 0x1000;  /* For softer buttons */
...
SupportColourFlagCUI = {
    text                          : 0x0000,
    selection_text                : 0x0002,
    inactive_selection_text       : 0x0004,
    background                    : 0x0008,
    selection_background          : 0x0010;
    inactive_selection_background : 0x0020,
    active_item_frame             : 0x0040,
    group_foreground              : 0x0080,
    group_background              : 0x0100,
    colour_flag_all               : 0x01ff
};
